...
![image](/img/blog/Pasted_image_20240729152435.png)
...
![image](/img/blog/Pasted_image_20240729152554.png) 

Make sure to select "Microsoft Windows" and select "Windows Server 2022" from the drop down menu.
![image](/img/blog/Pasted_image_20240729152619.png)
...
![image](/img/blog/Pasted_image_20240729152705.png)

Leave the disk size on the recommended, and select the single file option.
![image](/img/blog/Pasted_image_20240729152735.png)

Before we click "Finish" we will want to customize our hardware.
![image](/img/blog/Pasted_image_20240729152756.png)
...
![image](/img/blog/Pasted_image_20240729152901.png)
...
![image](/img/blog/Pasted_image_20240729152913.png)

Now, we're going to start our VM and press any key to boot up the Windows Installer.
![image](/img/blog/Pasted_image_20240729152957.png)
...
![image](/img/blog/Pasted_image_20240729153036.png)

Select the custom install option.
![image](/img/blog/Pasted_image_20240729153124.png)

Your 60gb drive that you create previously will show up here. Click next.
![image](/img/blog/Pasted_image_20240729153135.png)

It will now install the Windows Server. This will take a few minutes.
![image](/img/blog/Pasted_image_20240729153227.png) 
...
![image](/img/blog/Pasted_image_20240729162126.png)
...
![image](/img/blog/Pasted_image_20240729162356.png)
...
![image](/img/blog/Pasted_image_20240729165028.png)
...
![image](/img/blog/Pasted_image_20240729165734.png)
...
![image](/img/blog/Pasted_image_20240730142505.png)

Select Windows 10 x64 or 11 x64 depending on what operating system you decided to go with.

![image](/img/blog/Pasted_image_20240730142556.png)

Create an encryption password and store it somewhere safe.

![image](/img/blog/Pasted_image_20240730142739.png)

Choose your disk size. I went with the recommended.

![image](/img/blog/Pasted_image_20240730142803.png)

Click "Customize Hardware."

![image](/img/blog/Pasted_image_20240730142833.png)
...
![image](/img/blog/Pasted_image_20240730143144.png)

Under the Network Adapter, select the custom virtual network we created earlier. Finish the configuration and start the VM.

![image](/img/blog/Pasted_image_20240730143310.png)

Click Next to start the installation and setup process.

![image](/img/blog/Pasted_image_20240730143331.png)

Select "I don't have a product key."

![image](/img/blog/Pasted_image_20240730143404.png)

Select Windows 10/11 Pro.

![image](/img/blog/Pasted_image_20240730143456.png)

Select custom install and continue.

![image](/img/blog/Pasted_image_20240730143532.png)

Windows is now installing. This will take some time.

![image](/img/blog/Pasted_image_20240730143554.png)
...
![image](/img/blog/Pasted_image_20240807163716.png)

Click "Internet Protocol Version 4 (TCP/IPv4)" and click "Properties"

![image](/img/blog/Pasted_image_20240807163844.png)

![image](/img/blog/Pasted_image_20240807164309.png)
...
![image](/img/blog/Pasted_image_20240807164919.png)

In the Server Manager we will start by click "Add roles and features."

![image](/img/blog/Pasted_image_20240807164957.png)
...
![image](/img/blog/Pasted_image_20240807165221.png)

Then click, "Next" 

![image](/img/blog/Pasted_image_20240807165237.png)

Keep clicking Next until you get to the Confirmation page and then hit "Install"

![image](/img/blog/Pasted_image_20240807165431.png)

This will take some time.

![image](/img/blog/Pasted_image_20240807165505.png)
...
![image](/img/blog/Pasted_image_20240807165651.png)
...
![image](/img/blog/Pasted_image_20240807172832.png)
...
![image](/img/blog/Pasted_image_20240807173127.png)

Name it "\_USERS"

![image](/img/blog/Pasted_image_20240807173237.png)
...
![image](/img/blog/Pasted_image_20240807173453.png)
...
![image](/img/blog/Pasted_image_20240807173641.png)
...
![image](/img/blog/Pasted_image_20240807174306.png)

![image](/img/blog/Pasted_image_20240807174337.png)

I renamed the PC to "USER-PC1," but you can pick a name of your choosing.

![image](/img/blog/Pasted_image_20240807174450.png)
...
![image](/img/blog/Pasted_image_20240807175121.png)

Click Connect

![image](/img/blog/Pasted_image_20240807175151.png)

A new windows will pop up, click "Join this device to a local Active Directory domain" at the bottom.

![image](/img/blog/Pasted_image_20240807175239.png)

Type the domain name you created earlier and click next.

![image](/img/blog/Pasted_image_20240807175311.png)

This is where you'll type the information of the user account we created earlier.

![image](/img/blog/Pasted_image_20240807175806.png)

This will be a standard account.

![image](/img/blog/Pasted_image_20240807175828.png)
...
![image](/img/blog/Pasted_image_20240807180000.png)

If we check Active Directory, we can see that our PC "USER-PC1" now appears under "Computers."

![image](/img/blog/Pasted_image_20240807180316.png)
